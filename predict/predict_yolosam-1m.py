...
src_tif = r"/home/neaucs2/usr/xrx/yolo8-sam/test/ground_1m1-3bands.tif"
#src_tif = r"/home/neaucs2/usr/xrx/yolo8-sam/test/1m/use/8_17.jpg"
outtif = r"/home/neaucs2/usr/xrx/yolo8-sam/test/1m/result/55-8.19-500.tif"
...
endtime = datetime.datetime.now()
text = "---结果预测完毕,目前耗时间: " + str((endtime - starttime).seconds) + "s"
